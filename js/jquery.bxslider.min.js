...
jQuery(document).ready(function(){
	jQuery('.bxslider').each(function () {
		var fx = jQuery(this).data('fx'),
			pager = jQuery(this).data('pager'),
			speed = jQuery(this).data('speed'),
			CantoHideControlOnEnd = jQuery(this).data('hidecontrolonend'),
			auto = jQuery(this).data('auto'),
			infiniteLoop = jQuery(this).data('infiniteloop');
		...
		jQuery(this).bxSlider({
		    ...
		    hideControlOnEnd: CantoHideControlOnEnd,
		});
	});
